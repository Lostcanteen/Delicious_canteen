...
public class CommitBook extends HttpServlet{
...
public void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException {
        ...
        try {  
            ...
            String dishid = userobj.getString("dishid");
            String cnt = userobj.getString("cnt");
            ...
            db.commitBook(canteenid, date,(char) option, userid, dishid, cnt);
