...
public class AddCanteen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takePhoto.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    imageUri = FileProvider.getUriForFile(AddCanteen.this,
        ...
        chooseFromAlbum.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(AddCanteen.this,
                        android.Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(AddCanteen.this,new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                } else {
                    openAlbum();
                }
            }
    ...
    */
    ...
    private void initLayout(final ArrayList<String> arr) {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            final View view = (View) LayoutInflater.from(AddCanteen.this).inflate(R.layout.text_view, mTagLayout, false);
