package com.example.hieratic.first;
...
public class MainActivity extends ListActivity{
    ...
    private EditText estimate;//评价
    private Dialog dialog;//对话框布局
    ListView listView = null;
    int mYear,mMonth,mDay;//年，月，日，日期所用
    private Button btn,submitAccess,submitStar;//btn是选择三餐，submitAccess是提交评论
    final int DATE_DIALOG=1;//日历所用
    private RatingBar mRatingBar;//评星所用
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       SimpleAdapter adapter = new SimpleAdapter(this, lists,
                R.layout.activity_main, new String[] { "ImageView01",
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                btn.setText(new StringBuffer().append(mMonth + 1).append("-").append(mDay).append("-").append(mYear).append(" "));
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View arg0)
            {
                ...
                builder.setTitle("三餐");
                //    指定下拉列表的显示数据
                final String[] meals= {"早餐", "午餐", "晚餐"};
                //    设置一个下拉的列表选择项
                builder.setItems(meals, new DialogInterface.OnClickListener()
                {
                    @Override
                    public void onClick(DialogInterface dialog, int which)
                    {
                        button.setText(meals[which]);
                        Toast.makeText(MainActivity.this, "选择为：" + meals[which], Toast.LENGTH_SHORT).show();
                    }
                });
                builder.show();
            }
    ...
    public void toAccess(View view){
        ...
        //初始化控件
        submitAccess = (Button) inflate.findViewById(R.id.submitAccess);
        estimate = (EditText) inflate.findViewById(R.id.estimate);
        //将布局设置给Dialog
...
//       将属性设置给窗体
        ...
        estimate.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this,"请输入评价",Toast.LENGTH_SHORT).show();
            }
        });
        submitAccess.setOnClickListener(new View.OnClickListener() {
    ...
    public void toStar(View view){
        dialog = new Dialog(this,R.style.ActionSheetDialogStyle);
        //填充对话框的布局
        inflate = LayoutInflater.from(this).inflate(R.layout.star_layout, null);
        //初始化控件
        submitStar = (Button) inflate.findViewById(R.id.submitStar);
        mRatingBar = (RatingBar) inflate.findViewById(R.id.ratingbar);
        //将布局设置给Dialog
        dialog.setContentView(inflate);
        //获取当前Activity所在的窗体
        Window dialogWindow = dialog.getWindow();
...
//       将属性设置给窗体
        ...
        submitStar.setOnClickListener(new View.OnClickListener() {
